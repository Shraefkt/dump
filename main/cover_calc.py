...
if __name__ == '__main__':
    n_nodes = 127 #int(input("Number of documents:"))
    n_nodes = 2 ** get_depth(n_nodes) + n_nodes
    a = 65#convert_to_index_number(int(input("Input lower limit:")),n_nodes)
    b = 84#convert_to_index_number(int(input("Input upper limit:")),n_nodes)
