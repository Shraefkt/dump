...
def get_average_overhead(n_nodes,n_cover):
    ...
    for b in range(1,n_nodes+1):
        for a in range(1,b):
            overcover_nodes = calc_n_cover(convert_to_index_number(a,n_nodes),convert_to_index_number(b,n_nodes),n_cover,convert_to_index_number(n_nodes,n_nodes))
            over_number = get_number_overhead_nodes(convert_to_index_number(a,n_nodes),
                                                        convert_to_index_number(b,n_nodes),
                                                        convert_to_index_number(n_nodes,n_nodes),
